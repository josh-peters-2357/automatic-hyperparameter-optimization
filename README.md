# Automatic Hyperparameter Optimization and Application to Various Datasets
This repository contains my work to achieve departmental honors in Computer Science at Gordon College. It focuses in on how to automatically choose good hyperparameters for a linear regressor and investigates several regression types. This is, in one sense, a machine learning problem of its own- a meta problem to try and learn how best to set up the model without the need for HITL. Most of the description is in the actual Jupyter notebook! If you would like to see the thesis, please reach out to me at Josh.Peters@Gordon.edu so I can share you a private link.

## Conda Dependencies
The project was done using Jupyter inside Conda with Python 3.9. I was using matplotlib, numpy, pandas, seaborn, pydot, hdf5, jupyter, and scikit-learn.

(Below is output from `conda list`)  
```
